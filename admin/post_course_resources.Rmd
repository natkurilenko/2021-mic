...
3. [MIC Computing Environment](#Docker-Containers): Downloading and running the HTS Image in Docker or Singularity
4. [Course Data](#Course-Data): How to download the data we used in the MIC Course
