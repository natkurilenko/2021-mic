...
# Pipeline - combine the meta data and count files
...
We need to do the following:
    ...
    1. The DESeq2 package expects the experimental variables (in this case treatment and cell_line) to be "factors". We add two new variables (trt and cline) as factors. 
    
    2. DESeq2 does not like the "-" characters in the levels of its factors (e.g., as in the "anti-PD-1" level). We will remove these
...
This function adds three QC statistics to the transposed count matrix: 1. proportion of mapped reads (defined as number of mapped reads over depth count), proportion of reads mapped to regions with no gene annotation, and proportion of uniquely mapped reads
