> There are slight differences between these notes and the slides used in lecture because the slides were generated in R with knitr which has some capabilities that are not available in Jupyter
...
[Why should I use Version Control?](https://stackoverflow.com/a/1408464)

![Final.doc Phd Comic](http://www.phdcomics.com/comics/archive/phd101212s.gif)
