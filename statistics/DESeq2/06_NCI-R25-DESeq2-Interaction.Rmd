...
```{r}
**A bigger-picture sentence about why you should what happens when you flatten the 2 factors with 2 levels into 1 factors with 4 levels would be nice here**
```
