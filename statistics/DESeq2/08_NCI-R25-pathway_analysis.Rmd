...
procdir <- normalizePath("/Users/jichun/Box/Home Folder jx42/Teaching/MIC-2021/Pathway_Analysis_Workshop/Data/")
ddsfile <- file.path(procdir, "PRJNA668393-ddsdata.RDS")
dds <- readRDS(ddsfile)
tools::md5sum(ddsfile)
```
...
```{r}
Mm.H<- readRDS("~/Box/Home Folder jx42/Teaching/MIC-2021/Pathway_Analysis_Workshop/Data/Mm.h.all.v7.1.entrez.rds")
```
