...
The results for the top hit for treatment DE are shown below
...
* trt == 0 and cline == 0  => $\log2(q_{ij})$= 2.085754
* trt == 1 and cline == 0  => $\log2(q_{ij})$= 2.085754 + 1.704187
* trt == 0 and cline == 1  => $\log2(q_{ij})$= 2.085754 + 1.071143	
* trt == 1 and cline == 1  => $\log2(q_{ij})$= 2.085754 + 1.071143	+ 1.704187

The treatment DE effect unnder teh additive model does NOT depend on cell line

* if cline == 0 => (2.085754 + 1.704187) - 2.085754 = 1.704187 
* if cline == 1 => (2.085754 + 1.071143	+ 1.704187 ) -(2.085754 + 1.071143) = 1.704187
