...
# DESeq2: Create analysis ready data sets
...
qcfile <- file.path(outdir, "PRJNA668393-qcdata.RData")
ddsfile <- file.path(outdir, "PRJNA668393-ddsdata.RData")
