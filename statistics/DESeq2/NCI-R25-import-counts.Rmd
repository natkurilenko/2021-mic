...
## Objective: Import STAR count files
...
```{r}
cntdir <- normalizePath("/work/mic2021/rawdata/starout/")
...
Next, inspect the first ten rows. Columns 2 through 4 contain read counts. The choice for downstream analysis depends on the stranding of kit (we will use the fourth column). The first four rows, provide the corresponding counts for unmapped, multi-mapped, no-feature-mapped and ambigiously-mapped counts. The remaining rows, provide the gene counts.
