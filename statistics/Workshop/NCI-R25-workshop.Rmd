...
```
### Visualize effect size based on normalized counts for ENSMUSG00000110537.2 and ENSMUSG00000022564.8
...
DESeq2::summary(results(ddsADD, contrast = c("trt", "antiPD1", "isotype")), alpha = 0.2)
```
### Visualize effect size based on normalized counts for ENSMUSG00000022351.15 and ENSMUSG00000025964.16


#### Simple plots

```{r}
DESeq2::plotCounts(ddsobj, "ENSMUSG00000022351.15", intgroup = "trt", normalized = TRUE)

```

```{r}
DESeq2::plotCounts(ddsobj, "ENSMUSG00000025964.16", intgroup = "trt", normalized = TRUE)
```
